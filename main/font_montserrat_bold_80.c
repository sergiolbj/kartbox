 ...
 * Size: 80 px
 * Bpp: 4
 * Opts: --bpp 4 --size 80 --no-compress --stride 1 --align 1 --font Montserrat-Bold.ttf --range 32-127 --format lvgl -o font_montserrat_bold_80.c
 ******************************************************************************/
...
#ifndef FONT_MONTSERRAT_BOLD_80
#define FONT_MONTSERRAT_BOLD_80 1
#endif

#if FONT_MONTSERRAT_BOLD_80
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_montserrat_bold_80 = {
#else
lv_font_t font_montserrat_bold_80 = {
#endif
...
#endif /*#if FONT_MONTSERRAT_BOLD_80*/
